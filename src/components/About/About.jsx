		...
		<>
			...
			<div className="about container my-4">
				...
				<div className="objectives container row">
					<div className="obj col-md-4">
						<img src="/images/brands/mission.png" alt="Mission" />
						<p>
					...
					<div className="obj col-md-4">
						<img src="/images/brands/values.png" alt="Values" />
						<p>
					...
					<div className="obj col-md-4">
						<img src="/images/brands/vision.png" alt="Vision" />
						<p>
							Thrive to be the best Real Estate Broker, providing
							excellent and consistent customer experience while
							establishing longterm productive relationships with
							clients and investing in staff by helping them
							develop new skillset that will take them, the
							company and the real estate market to lofty heights.
						</p>
					</div>
				</div>
				<div className="brands row">
					<img
						src="/images/brands/cascade.png"
						alt="Cascade Voyage"
						className="img-fluid"
					/>
					<img
					...
					/>
					<img
						src="/images/brands/pavillion.png"
						alt="Pavillion"
						className="img-fluid"
					/>
					<img
						src="/images/brands/MIDSPRINGS PARK.png"
						alt="MIDSPRINGS PARK"
						className="img-fluid"
					/>
					<img
						src="/images/brands/tudio height.png"
						alt="Tudio Height"
						className="img-fluid"
					/>
					<img
						src="/images/brands/oakwood realtor.png"
						alt="Oakwood Realtor"
						className="img-fluid"
					/>
					<img
						src="/images/brands/skyfall.png"
						alt="Skyfall"
						className="img-fluid"
					/>
					<img
						src="/images/brands/tufion farm.png"
						alt="Tufion Farm"
						className="img-fluid"
					/>
					<img
						src="/images/brands/umbrealla.png"
						alt="Umbrella"
						className="img-fluid"
					/>
					<img
						src="/images/brands/skyfall legal logo.png"
						alt="Skyfall Legal"
						className="img-fluid"
					/>
					<img
						src="/images/brands/URBAN PACIFIC LOGO.png"
						alt="Urban Pacific"
						className="img-fluid"
					/>
					<img
						src="/images/brands/five fingers.png"
						alt="Five Fingers"
						className="img-fluid"
					/>
					<img
						src="/images/brands/terica.png"
						alt="Terica"
						className="img-fluid"
					/>
					<img
